<?php
	...
	function addarticulo(){
		...
		. " VALUES (" . 2 . ", '" . $modelo . "', " . $anio . ", '" . $marcaObj->id . "', " . 0 . ", '" . $img . "', " . $precio . ", '" . $desc . "')";
	...
	function renderarticulos($lista){ 
		...
		foreach($lista as $obj){
			...
			$html .= "<input type='button' class='edit-button' value='editar' onClick='showArticulo(" . $obj->id . ")' />";
			$html .= "<input type='button' class='delete-button' value='eliminar' onClick='delArticulo(" . $obj->id . ")' />";
			$html .= "</span>";
			$html .= "</div>";
			$html .= "</div>";
		}
